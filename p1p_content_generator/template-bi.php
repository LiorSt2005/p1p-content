    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .sec-sub { font-size: 16px; margin-bottom: 36px; }
            ...
            .agitate { padding: 60px 20px; }
            .agitate-q { font-size: 24px; }
            .agitate-sub { font-size: 15px; }

            .modal-box { padding: 36px 24px; margin: 0 20px; }
        }
    </style>
</head>
<body>
